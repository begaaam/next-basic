...
export const Header = () =>{
    ...
    return (
        <div className={styles.header}>
          <Link href="/" passHref>
            <span className={router.pathname === "/" ? styles.active:styles.active.link}>Home</span>
            </Link>
            <Link href="/blog" passHref>
            <span className={router.pathname=== "/blog" ? styles.active:styles.link}>Blog</span>
            </Link>
            <Link href="/profile" passHref>
            <span sclassName={router.pathname === "/profile" ? styles.active : styles.link}>Profile</span>
            </Link>
            ...
            <span className={router.pathname==="/dapartements" ? styles.active : styles.link}>Departements</span>
            </Link>
        </div>
    )
}